...
(function (d3$1) {
    ...
    const render = (graph) => {
        ...
        const colorScales = {
            "buying": ['hsl(60, 100%, 80%)', 'hsl(60, 100%, 60%)', 'hsl(60, 100%, 40%)', 'hsl(60, 100%, 30%)'],
            "maintenance": ['hsl(250, 100%, 80%)', 'hsl(250, 100%, 70%)', 'hsl(250, 100%, 50%)', 'hsl(250, 100%, 30%)'],
            "doors": ['hsl(90, 100%, 80%)', 'hsl(90, 100%, 70%)', 'hsl(90, 100%, 50%)', 'hsl(90, 100%, 30%)'],
            "persons": ['hsl(20, 100%, 80%)', 'hsl(20, 100%, 50%)', 'hsl(20, 100%, 30%)'],
            'luggage boot': ['hsl(310, 100%, 80%)', 'hsl(310, 100%, 50%)', 'hsl(310, 100%, 30%)'],
            "safety": ['hsl(178, 100%, 80%)', 'hsl(178, 100%, 50%)', 'hsl(178, 100%, 30%)'],
        };
        ...
        svg.append("rect")
            ...
            .attr("width", 10)
            .attr("height", 10)
            .style("fill", "hsl(60, 100%, 50%)")
            .style("stroke", "#000000ff")
        svg.append("text")
            .attr("class", "legend")
            .attr("x", (margin.left) + 15)
            .attr("y", (margin.top / 2) - 40)
            .text("buying : buying price")
        ...
        svg.append("rect")
            ...
            .attr("width", 10)
            .attr("height", 10)
            .style("fill", "hsl(250, 100%, 50%)")
            .style("stroke", "#000000ff")
        svg.append("text")
            .attr("class", "legend")
            .attr("x", (margin.left) + 185)
            .attr("y", (margin.top / 2) - 40)
            .text("maintenance : price of the maintenance")
        
        svg.append("rect")
            .attr("x", (margin.left) + 470)
            .attr("y", (margin.top / 2) - 50)
            .attr("width", 10)
            .attr("height", 10)
        ...
        svg.append("text")
            .attr("class", "legend")
            .attr("x", (margin.left) + 485)
            .attr("y", (margin.top / 2) - 40)
            .text("doors : number of car doors")
        ...
        svg.append("rect")
            ...
            .attr("width", 10)
            .attr("height", 10)
            .style("fill", "hsl(20, 100%, 50%)")
            .style("stroke", "#000000ff")
        svg.append("text")
            .attr("class", "legend")
            .attr("x", (margin.left) + 15)
            .attr("y", (margin.top / 2) - 20)
            .text("persons : capacity in terms of persons to carry")
        ...
        svg.append("rect")
            ...
            .attr("width", 10)
            .attr("height", 10)
            .style("fill", "hsl(310, 100%, 50%)")
            .style("stroke", "#000000ff")
        svg.append("text")
            .attr("class", "legend")
            .attr("x", (margin.left) + 360)
            .attr("y", (margin.top / 2) - 20)
            .text("luggage boot : the size of luggage boot")
        ...
        svg.append("rect")
            ...
            .attr("width", 10)
            .attr("height", 10)
            .style("fill", "hsl(178, 100%, 50%)")
            .style("stroke", "#000000ff")
        svg.append("text")
            .attr("class", "legend")
            .attr("x", (margin.left) + 665)
            .attr("y", (margin.top / 2) - 20)
            .text("safety : estimated safety of the car")
